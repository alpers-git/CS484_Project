#need to install opencv and pytorch from the anaconda cli for desired environment 
...
for dirName, subdirList, fileList in os.walk(rootDir):
    ...
    #write feature vector in to a structure
    t_ClassNames.append(className)
    t_FeatureVectors.append(feature_vector)
